...
- (void)addButtonsToView: (UIView *)container {
    ...
    int width = container.bounds.size.width-40;
    CGFloat buttonWidth = width / [buttonTitles count];
    ...
    for (int i = 0; i<[buttonTitles count]; i++) {
        ...
        if (i == 0) {
            [closeButton setFrame:CGRectMake(20, container.bounds.size.height - buttonHeight-22, buttonWidth, buttonHeight)];
            
            maskPath = [UIBezierPath bezierPathWithRoundedRect:closeButton.bounds byRoundingCorners:(UIRectCornerBottomLeft) cornerRadii:CGSizeMake(10.0, 10.0)];
        }else{
            
            [closeButton setFrame:CGRectMake(20+buttonWidth, container.bounds.size.height - buttonHeight-22, buttonWidth, buttonHeight)];
            
            maskPath = [UIBezierPath bezierPathWithRoundedRect:closeButton.bounds byRoundingCorners:(UIRectCornerBottomRight) cornerRadii:CGSizeMake(10.0, 10.0)];
     }
